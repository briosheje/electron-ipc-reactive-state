...
import { DemoProgressBar } from './ui/components/demo-progressbar';
...
export default function Index() {
  const [state, updateState] = useReactiveState<SharedState>('shared-state');
